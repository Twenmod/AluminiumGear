...
namespace ImGui
{
    ...
    IMGUI_API void          NewFrame(bool updateInputs = true);                                 // start a new Dear ImGui frame, you can submit any command from this point until Render()/EndFrame().
    IMGUI_API void          EndFrame(bool updateInputs = true);                                 // ends the Dear ImGui frame. automatically called by Render(). If you don't need to render data (skipping rendering) you may call EndFrame() without Render()... but you'll have wasted CPU already! If you don't need to render, better to not create any windows and not call NewFrame() at all!
...
enum ImGuiWindowFlags_
{
	...
	ImGuiWindowFlags_Draw3D                 = 1 << 20, // Uses SetMVP instead of ortho project
